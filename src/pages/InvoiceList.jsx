...
const InvoiceList = () => {
  ...
  const handleCopyClick = () => {
    ...
    if (!invoice) {
      toast.error("Invoice not found. please enter valid invoice number");
    } else {
  ...
  return (
    <Row>
      <Col className="mx-auto" xs={12} md={8} lg={9}>
        <h3 className="fw-bold pb-2 pb-md-4 text-center">Invoice Tab</h3>
        <Card className="d-flex p-3 p-md-4 my-3 my-md-4 ">
          {isListEmpty ? (
            <div className="d-flex flex-column align-items-center">
              <h3 className="fw-bold pb-2 pb-md-4">No invoices present</h3>
              <Link to="/create">
                <Button variant="info">Create Invoice</Button>
              </Link>
            </div>
          ) : (
            <div className="d-flex flex-column">
              <div className="d-flex flex-row align-items-center justify-content-between">
                ...
                <Link to="/create">
                  <Button variant="info mb-2 mb-md-4">Create Invoice</Button>
                </Link>

                <div className="d-flex gap-2">
                  <Button variant="success mb-2 mb-md-4" onClick={handleCopyClick}>
                    Copy Invoice
                  </Button>
                  ...
                  <input
                    ...
                    className="bg-white border border-dark rounded"
                    style={{
                      height: "40px",
                    }}
                  />
